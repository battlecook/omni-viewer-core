...
describe('independent viewer detection',()=>{it.each([
 ...
 ['video',['mp4','mts','m2ts','avi','mov','wmv','flv','webm','mkv']],['dbc',['dbc']],['arxml',['arxml']],['a2l',['a2l']],['asc',['asc']],['blf',['blf']],['mf4',['mf4']],['pcap',['pcap']],['pcapng',['pcapng']],['mermaid',['mmd','mermaid']],['plantuml',['puml','plantuml','iuml']],['shapefile',['shp']],['psd',['psd']],['gguf',['gguf']],['onnx',['onnx']]
...
it('registers one independent descriptor per requested viewer',()=>{for(const id of ['audio','video','dbc','arxml','a2l','asc','blf','mf4','pcap','pcapng','mermaid','plantuml','shapefile','psd','gguf','onnx'])expect(CORE_VIEWER_DESCRIPTORS.filter(x=>x.id===id)).toHaveLength(1);});
